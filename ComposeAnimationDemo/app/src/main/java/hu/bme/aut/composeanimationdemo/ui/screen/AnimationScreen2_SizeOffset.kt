...
fun AnimationScreen2() {
    ...
    val size by animateDpAsState(
        ...
        keyframes {
            durationMillis = 6000
            sizeState * 2.0f at 2000 with LinearEasing
            sizeState * 0.1f at 3000 with LinearEasing
            sizeState * 1.2f at 4000 with FastOutLinearInEasing
            sizeState * 1f at 6000 with FastOutLinearInEasing
        }, label = "size"
    )
